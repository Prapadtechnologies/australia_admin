<div class="row">
    <div class="col-md-12" style="">
        <form id="category_id" action="<?php echo base_url('admin/edit_categories?id='.$_GET['id']);?>" method="post" class="needs-validation reset" novalidate="" enctype="multipart/form-data">
            ...
            <section class="card">
                ...
                <header class="card-header">
                    ...
                    <h2 class="card-title ven">Edit Categories</h2>
                </header>
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea name="terms_conditions" class="form-control"><?php echo $category['terms']; ?></textarea>
                        </div>
                        <div class="invalid-feedback">Terms and Conditions?</div>
                        <?php echo form_error('terms_conditions','<div style="color:red">','</div>');?>
                    </div>
