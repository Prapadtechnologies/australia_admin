<div class="row">
    <div class="col-md-12" style="">
        <form id="form_site_settings" action="<?php echo base_url('add_sub_categories');?>" method="post" class="needs-validation reset" novalidate="" enctype="multipart/form-data">
            <section class="card">
                <div>
                    <ol class="breadcrumb">
                ...
                <header class="card-header">
                    ...
                    <h2 class="card-title ven">Add SubCategories</h2>
                </header>
                <div class="card-body">
                    <!-- Category ID -->
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="invalid-feedback">Please enter Category ID</div>
