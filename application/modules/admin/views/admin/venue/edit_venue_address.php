      ...
      <form id="category_id" action="<?php echo base_url('edit_venue_address?id=' . $_GET['id']); ?>" method="post" class="needs-validation reset" novalidate="" enctype="multipart/form-data">
         ...
         <div class="card-body">
            ...
            <div class="form-group row">
               ...
               <div class="col-sm-9">
                  <input type="text" id="address_line_one" name="address_line_one" class="form-control" value="<?php echo $category['addressLineOne']; ?>">
               </div>
            ...
            <div class="form-group row">
               ...
               <div class="col-sm-9">
                  <input type="text" id="capacity" name="capacity" class="form-control"  value="<?php echo $category['capacity']; ?>">
               </div>
            ...
            <div class="form-group row">
               ...
               <div class="col-sm-9">
                  <input type="text" id="city" name="city" class="form-control"  value="<?php echo $category['city']; ?>">
               </div>
            ...
            <div class="form-group row">
               ...
               <div class="col-sm-9">
                  <input type="text" id="phone" name="phone" class="form-control"  value="<?php echo $category['phone']; ?>">
               </div>
            ...
            <div class="form-group row">
               ...
               <div class="col-sm-9">
                  <input type="text" id="country" name="country" class="form-control"  value="<?php echo $category['country']; ?>">
               </div>
            ...
            <div class="form-group row">
               ...
               <div class="col-sm-9">
                  <input type="text" id="postal_code" name="postal_code" class="form-control"  value="<?php echo $category['postalCode']; ?>">
               </div>
