...
<div class="main-sidebar sidebar-style-2">
	...
	<?php if($this->ion_auth_acl->has_permission('withdrawal')):?>
		...
		<?php if($this->ion_auth_acl->has_permission('emp') || $this->ion_auth_acl->has_permission('hr')):?>
    				    ...
    				    <li class="dropdown <?php echo ($title == 'Categories' || $title == 'SubCategories' || $title == 'Colours' || $title == 'Countries' || $title == 'Currency' || $title == 'SizesTypes' || $title == 'Sizes' || $title == 'UsersAdmin' || $title == 'VenueAddress') ? 'active' : '';?>">
    				    	<a href="#" class="nav-link has-dropdown"><i class="fa fa-list"></i><span>Setup</span></a>
    				    	<ul class="dropdown-menu">
    				    		<?php if($this->ion_auth_acl->has_permission('admin')):?>
    				    			<li class="<?php echo $title == 'Categories' ? 'active' : '';?>"><a class="nav-link" href="<?php echo base_url('Categories');?>">Categories</a></li>
    				    		<?php endif;?>
    				    		<?php if($this->ion_auth_acl->has_permission('admin')):?>
    				    			<li class="<?php echo $title == 'SubCategories' ? 'active' : '';?>"><a class="nav-link" href="<?php echo base_url('SubCategories'); ?>">Sub_Categories</a></li>
    				    		<?php endif;?>
    				    		<?php if($this->ion_auth_acl->has_permission('admin')):?>
    				    			<li class="<?php echo $title == 'Colours' ? 'active' : '';?>"><a class="nav-link" href="<?php echo base_url('Colours'); ?>">Colours</a></li>
    				    		<?php endif;?>
    				    		<li class="<?php echo $title == 'Countries' ? 'active' : '';?>"><a class="nav-link" href="<?php echo base_url('Countries'); ?>">Countries</a></li>
    				    		<li class="<?php echo $title == 'Currency' ? 'active' : '';?>"><a class="nav-link" href="<?php echo base_url('Currency'); ?>">Currency</a></li>
    				    		<li class="<?php echo $title == 'SizesTypes' ? 'active' : '';?>"><a class="nav-link" href="<?php echo base_url('SizesTypes'); ?>">Sizes Types</a></li>
    				    		<li class="<?php echo $title == 'Sizes' ? 'active' : '';?>"><a class="nav-link" href="<?php echo base_url('Sizes'); ?>">Sizes</a></li>
    				    		<!-- <li class="<?php echo $title == 'UsersAdmin' ? 'active' : '';?>"><a class="nav-link" href="<?php echo base_url('UsersAdmin'); ?>">Users</a></li> -->
    				    		<li class="<?php echo $title == 'VenueAddress' ? 'active' : '';?>"><a class="nav-link" href="<?php echo base_url('VenueAddress'); ?>">Venue Address</a></li>
    				    	</ul>
    				    </li>
